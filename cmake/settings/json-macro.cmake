...
# Read json 'file' into varable with name equal to 'output_var'
macro(readJsonFile file output_var)
    file(READ ${file} JSON_STRING)

    parseJson(${output_var} JSON_STRING)
endmacro()
